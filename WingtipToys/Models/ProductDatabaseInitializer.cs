        ...
        private static List<Product> GetProducts()
        {
            var products = new List<Product>
            {
                new Product
                {
                    ...
                    Description = "This convertible car is fast! The engine is powered by a neutrino based battery (not include)." + "Power it up and let it go!",
                ...
                new Product
                {
                    ...
                    Description = "Authentic airplane toy. Features realistic color and detail.",
                ...
                new Product
                {
                    ...
                    Description = "This toy truck has a real gas powered engine. Required regular tune ups.",
